...
define([
    ...
    Notebook.prototype.get_msg_cell = function (msg_id) {
        console.log("getting msg cell with uuid: " + msg_id);
    ...
    Notebook.prototype.save_notebook = function (check_last_modified) {
        ...
        var that = this;
        var _save = function () {
            console.log("***************************************************Notebook path: " + that.notebook_path);
     ...
     * @param {object}  data - JSON representation of a notebook
     * @param {string}  path - Optional. The path of the python notebook
     */
    Notebook.prototype.save_notebook_success = function (start, data, path="") {
        this.set_dirty(false);
